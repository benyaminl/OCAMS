...
public class FrameAbsensi extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql = "INSERT INTO ABSENSI VALUES('"+txtID.getText()
                +"',DATE_FORMAT(CURRENT_TIME,'%H%i'),'',CURRENT_DATE)"
                + " on DUPLICATE KEY UPDATE jam_keluar = DATE_FORMAT(CURRENT_TIME,'%H%i')";
        if(OCAMS.SQL.executeNonQuery(sql) > 0){
            JOptionPane.showMessageDialog(this, "Anda Berhasil Absen "
                    +OCAMS.SQL.executeGetScalar("SELECT nama from user where id_user = '"
                            +txtID.getText()+"'")+"!");
        }
