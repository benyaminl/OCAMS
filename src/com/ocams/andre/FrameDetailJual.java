...
public class FrameDetailJual extends javax.swing.JFrame {
    public FrameDetailJual() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDetailJual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDetailJual().setVisible(true);
            }
        });
    }
